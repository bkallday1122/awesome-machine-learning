...
* [DLib](http://dlib.net/ml.html) - A suite of ML tools designed to be easy to embed in other applications.
...
* [Torch7](http://torch.ch/)
  ...
  * [torchnet](https://github.com/torchnet/torchnet) - framework for torch which provides a set of abstractions aiming at encouraging code reuse as well as encouraging modular programming.
...
* [Spider](https://people.kyb.tuebingen.mpg.de/spider/) - The spider is intended to be a complete object-oriented environment for machine learning in Matlab.
...
* [Wallaroo.AI](https://wallaroo.ai/) - Production AI platform for deploying, managing, and observing any model at scale across any environment from cloud to edge. Let's go from python notebook to inferencing in minutes.
